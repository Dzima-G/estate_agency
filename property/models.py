...
class Owner(models.Model):
    name = models.CharField(max_length=200, verbose_name='ФИО', db_index=True)
    ...
    owned_apartments = models.ManyToManyField(Flat, verbose_name='Квартиры в собственности', related_name='owned_by')
